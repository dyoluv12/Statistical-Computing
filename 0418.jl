...
# ╔═╡ 2c2ece20-fd50-11ee-097b-8b6616a386ae
using PlutoUI,Images,Distributions,LinearAlgebra

# ╔═╡ 01345042-fc20-456f-ba22-d212dac16adc
PlutoUI.TableOfContents()

# ╔═╡ 6f3b38f8-d97c-49fe-805f-0c9af3587f8f
md"""
### 프랑스 국기
"""

# ╔═╡ cb6bcd98-c2f7-47f1-b639-7a38c10bf22f
md"""
어떤 (n,m) 이미지를 표현하기 위해 항상 n x m 개의 픽셀이 필요한 것은 아니다.
"""

# ╔═╡ 6b6c3297-fe5c-4377-9eee-1655181a46c4
#표현1

# ╔═╡ 5b67a51d-e2ef-45ad-8768-68263ab2142c
let
	B = RGB(0, 0, 1)
	W = RGB(1, 1, 1)
	R = RGB(1, 0, 0)
	...
	France = [
		...
		B B W W R R
		B B W W R R
		B B W W R R #여기까지 (4,6) 행렬
	]
end

# ╔═╡ 3ca1d2de-bbc5-4e58-bb23-6fbd2e964806
#표현2

# ╔═╡ ec7a2234-9ed1-461c-bad1-40ec3eaae3ac
let
	B = RGB(0, 0, 1)
	W = RGB(1, 1, 1)
	R = RGB(1, 0, 0)
	j = ones(4) #(4,1) 행렬
	[B B W W R R] #(1, 6) 행렬
	j * [B B W W R R] #(4,6) 행렬
end

# ╔═╡ ac71cc44-3a93-4f8b-880c-7c3a83a44766
#표현3

# ╔═╡ e9f52a6d-dde5-42ad-839b-4f208f6e7430
let
	j = ones(4)
	r = [0 0 1 1 1 1]
	g = [0 0 1 1 0 0]
	...
	G = j*g
	B = j*b
	France = stack([R, G, B], dims=1) #3 x 4 x 6
	colorview(RGB, stack([R, G, B], dims=1))
end

# ╔═╡ 3b491f85-cedc-40a8-8170-1f8a9d503b51
#표현 3의 스택 없이 하는 방법

# ╔═╡ f00ffc95-047e-4535-bc33-bb701a25becc
let
	j = ones(4)
	r = [0 0 1 1 1 1]
	g = [0 0 1 1 0 0]
	...
	G = j*g
	B = j*b
	colorview(RGB, R, G, B) #3 x 4 x 6
end

# ╔═╡ 48d53a69-a075-409c-a195-63aff1e22799
md"""
### 그리스 국기
"""

# ╔═╡ 66ce2ff8-5f1e-4b5d-b380-ff03702b3ebe
begin
...
# ╔═╡ 382a60c5-f898-4f36-ab73-aa148a1ee664
let
	...
	#9 x 1 벡터 x 1 x 13 벡터 = 9 x 13 행렬
	G = 7.80U1g*V1g' + 1.75U2g*V2g' + 0.82U3g*V3g'
	#9 x 1 벡터 x 1 x 13 벡터 = 9 x 13 행렬
	B = 9.36U1b*V1b' + 0.88U2b*V2b' + 0.37U3b*V3b'
	#9 x 1 벡터 x 1 x 13 벡터 = 9 x 13 행렬
	colorview(RGB,R,G,B) #3 x 9 x 13
end

# ╔═╡ 10b53245-b911-498a-84d4-51e281f2e02e
md"""
### 행렬
"""

# ╔═╡ a170216d-0e34-41eb-9dab-aba628bb1fb3


# ╔═╡ 5eca0594-a339-4486-97c7-aac49e5f7b88
let
	A1 = [1,2]
	A2 = [3,4]
	A = [A1 A2]
...
# ╔═╡ cbdf4e81-1cb2-46c5-a262-fefd7c0c0e47
let 
...
# ╔═╡ 3b197fee-e8bc-4541-bd5f-7dc8a412142e
md"""
아무렇게나 쪼개면 곱이 자못될 수도 있다. 차원이 안맞을 수도 있음.

차원에 맞게 잘 쪼개면 곱셈이 성립 함.
"""

# ╔═╡ 7c2ebbcd-47cc-4d6a-a61f-038ae63bed99
md"""
### SVD
"""

# ╔═╡ 8e1e7844-3e75-4cb9-8525-a1a6101e2854
md"""
- 임의의 매트릭스 X_nxp 는 항상 X = UDVᵀ 로 분해 가능하다.

 -- D : 대각행렬(무조건), 차원은 m x m (m := min(n, p))

 -- U와 Vᵀ : 직교행렬(또는 비슷한 것)

 -- U, D, V의 차원은 모양에 따라 다르다. U와 Vᵀ 중 정사각형 모양인 행렬이 직교행렬이 된다.

 -- 차원이 m x m으로 나오는 행렬이면 단위행렬이 된다.

강의노트 이론 꼭 외우기!
"""

# ╔═╡ 562e7a0a-0085-4a2e-87b8-5f3f39c3f243
X = [1 1; 1 2; 5 4]

# ╔═╡ 143b8144-0ced-48dd-b3f3-07f8b101a740
F = svd(X) #하면 나오는 U, singular values(=D), V

# ╔═╡ 70b15d46-dd01-48ad-ae96-e5cce2dd723f
Diagonal(F.S)

# ╔═╡ 3d495564-6f50-4a2a-a52f-e38eca1156df
U, d, V = svd(X)

# ╔═╡ 5e860a89-79a4-4940-ab6f-a20069711283
U, d, V #d는 컬럼벡터 형태임

# ╔═╡ f61628a1-40d0-4cc5-adb9-942419f2666a
U * Diagonal(d) * V'

# ╔═╡ 3db5954d-f540-4c8f-bd91-d76b27803ee7
V * V'

# ╔═╡ 56f81b02-c72b-4fc0-93e0-061b78087744
V'*V

# ╔═╡ 4f20fc8c-3e40-467c-a1dc-e203f2f1891d
#V는 직교행렬

# ╔═╡ 1224aa13-5ef4-444d-b605-b372a2157859
U*U'

# ╔═╡ 0f6917a3-8391-429d-abc1-a582ca6f8806
U'U

# ╔═╡ c5e888ee-3cbb-4f91-80e9-84229b8c6a85
#U는 직교행렬이 아님 (반절 정도만 직교행렬)

# ╔═╡ 2aad1748-ab21-449c-9c85-857c07a8dea8
md"""
### SVD의 벡터화표현
"""

# ╔═╡ 59336224-6e45-4968-8ad1-430820069d11
md"""
X = UDVᵀ는
...
# ╔═╡ 84e422f4-fa37-4ced-a0b4-9d856d576519


# ╔═╡ 5bf029da-f4e0-49ee-a74e-ee3a3ac94346


# ╔═╡ eaaa55cc-26b3-47cb-bedd-17d917d2338d


# ╔═╡ 1c11b48a-1a77-4b0c-9b9d-f761d31e71f3
...
manifest_format = "2.0"
project_hash = "db7e163827280f3feda9e43934ce6c0ca177f062"
